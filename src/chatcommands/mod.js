        ...
        if (!privileged) {
            ...
            data.GUILD.roles.forEach((role) => {
                if (role.id == roleid) {
                    ...
                    if (CONSTANTS.MONS.indexOf(wantedMon) > -1 ||
                            CONSTANTS.RAIDMONS.indexOf(wantedMon) > -1 ||
                            CONSTANTS.LEGENDARYMONS.indexOf(wantedMon) > -1 ||
                            CONSTANTS.SPECIALMONS.indexOf(wantedMon) > -1 ||
                            CONSTANTS.SPECIALRAIDS.indexOf(wantedMon) > -1 ||
                            CONSTANTS.QUESTREWARDS.indexOf(wantedMon) > -1 ||
                        ...
                        reply = '**HEY** :rage: \nDo **NOT** use the @ tag when reporting Pokemon or Raids; that\'s my job! Please use the appropriate **!raid**, **!egg**, or **!wild** commands instead.\nFor usage and rules, please read Rule#5 in '
                            + data.channelsByName[CONSTANTS.DEFAULT_CHANNEL] + '. You have been warned!';
